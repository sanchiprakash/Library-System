...
switch ($radio){
                        ...
                        case 'Publisher' :
                        $result = mysqli_query($conn,"SELECT * FROM books  WHERE publisher LIKE '$_POST[search1]' ");

                         break;

                        case 'Title' :	
                        $result = mysqli_query($conn,"SELECT * FROM books  WHERE  title LIKE '$_POST[search1]' ");

                         break;

                        case 'Author' :
                        $result = mysqli_query($conn,"SELECT * FROM books WHERE author LIKE '$_POST[search1]' ");

                         break;

                        case 'Subject' :
                        $result = mysqli_query($conn,"SELECT * FROM books  WHERE subject LIKE '$_POST[search1]' ");
...
echo "<div style='padding: 10px 50px 10px 50px;'>
   ...
   <b><font size='4'>Author:</font>&nbsp&nbsp&nbsp</b>".$row['Author']."<br>"."<b><font size='4'>Title:</font>&nbsp&nbsp&nbsp</b>".$row['Title']."<br>"."<b><font size='4'>Publisher:&nbsp&nbsp&nbsp</b>".$row['publisher']."<br>"."<b><font size='4'>Price:</font>&nbsp&nbsp&nbsp</b>".$row['Price']."<br>"."
   <b><font size='4'>Subject:</font>&nbsp&nbsp&nbsp</b>".$row['SUBJECT']."<br>"."
   <b><font size='4'>Rating:</font>&nbsp&nbsp&nbsp</b>".$row['Rating']."<br>"." 
   <br><br>
   </p>
